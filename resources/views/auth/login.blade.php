                        ...
                        <form method="POST" action="{{ route('login.user') }}">
                            ...
                            <div class="form-group">
                                <div class="position-relative has-icon-left">
                                    <label for="exampleInputUsername" class="sr-only">Username or Email</label>

                                    <input type="text" placeholder="Enter Email  or User name" class="form-control {{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}" id="login-username" name="login" autocomplete="off" value="{{ old('username') ?: old('email') }}">
                                    @error('login')
                            ...
                            <div class="text-center pt-3">
                                ...
                                <hr>
                                <p class="text-dark">Do not have an account? <a href="{{ route('register') }}"> <strong>Sign Up here</strong></a></p>
                            </div>
                        </form>
                    </div>
                </div>
